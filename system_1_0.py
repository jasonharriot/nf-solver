...
def eval_system_1_0(params):
	...
	#Stage 3
	FS3.perscribe_input(f2_3)
	(f3_3, s3) = FS3.get_result()
	#print(f3_3, net_sign_str(sign))
	f3_2 = FS3.permeate

	#Interstage 2, permeate mixing
	IS2.perscribe_inputs([f1_2, f2_2, f3_2])
	...
	CV.perscribe_outputs([f3_3, f4_2])
	...
	results = {
		...
		'A3': PrettyArea(FS3.membrane.area),
